...
function ChangePassword() {
  ...
  const dashboard = localStorage.getItem("role") === "admin" ? "/admin" : "/user";
  ...
  const handleSubmit = (e) => {
    ...
    if (password === oldPassword) {
      showToast("New password cannot be same as old password.", "warning"); return;
    }
    ...
    axios.post(__userapiurl + "changepassword", {
      ...
      .catch(err => showToast(err.response?.data?.message || "Error updating password.", "error"))
