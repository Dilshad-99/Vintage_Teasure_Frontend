    ...
    <div className="page-section admin-home-page">
      ...
      <div className="admin-stats">
        ...
        <div className="stat-card">
          ...
          <h4>Total Users</h4>
          {loading ? <div className="stat-skeleton" /> : <p className="stat-count">{total}</p>}
        </div>

        <div className="stat-card">
          <span className="stat-icon">✅</span>
          <h4>Active Users</h4>
          {loading ? <div className="stat-skeleton" /> : <p className="stat-count" style={{ color: 'var(--color-success, green)' }}>{active}</p>}
        </div>

        <div className="stat-card">
          <span className="stat-icon">❌</span>
          <h4>Inactive Users</h4>
          {loading ? <div className="stat-skeleton" /> : <p className="stat-count" style={{ color: 'var(--color-danger, red)' }}>{inactive}</p>}
        </div>
